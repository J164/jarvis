...
import { Destinations, sendPaginatedMessage } from '../util/message-component-helpers.js';
...
export const handler: ChatInputCommandHandler<true> = {
	...
	async respond(response) {
		await sendPaginatedMessage(
			{ type: Destinations.InteractionEditReply, interaction: response.interaction },
